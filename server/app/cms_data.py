...
MEMBER_RULES = [
        ...
        "blocks": [
            {
                "subtitle": "1.1 会员性质",
                "paras": [
                    "天天聚乐部会员为年卡制，用户通过小程序在线支付年费开通或续费，不设 V0–V3 等级。",
                    "开通成功后即享会员权益，有效期自开通（或续费起算日）起按配置天数计算，默认 365 天。",
                ],
            },
            {
                "subtitle": "1.2 开通与续费",
                "paras": [
                    "年费金额以小程序会员中心展示及后台配置为准。",
                    "有效期内续费：自当前到期日起延长相应天数；已过期再开通：自支付成功当日重新起算。",
                ],
            },
        ],
    },
    {
        ...
        "blocks": [
            {
                "subtitle": "2.1 订菜免定金预约",
                "paras": [
                    "会员可在小程序免费预约（包房/聚餐套餐等），系统生成预约单并占档，到店后再结算消费。",
                    "非会员仍按原流程：下单后需在线支付，支付成功后锁定档期。",
                    {"text": "注：未选择用餐日期的预约为意向单，不占档、不进入当日备菜；补选日期后方可正式占档。", "tip": True},
                ],
            },
            {
                "subtitle": "2.2 会员优惠（到店对账）",
                "paras": [
                    "会员到店消费可按配置折扣享受优惠（默认九折）。折扣仅作为到店应收参考记入订单，便于门店对账，不改变非会员线上支付金额。",
                    {"text": "注：具体折扣比例以后台「会员配置」为准，门店结账时以实际解释为准。", "tip": True},
                ],
            },
            {
                "subtitle": "2.3 生日礼遇",
                "paras": [
                    "生日月到店消费，可享生日礼（如生日蛋糕、红酒等），具体内容以会员中心展示及门店确认为准。",
                    {"text": "注：请提前告知门店生日信息与到店日期，便于准备。", "tip": True},
                ],
            },
            {
                "subtitle": "2.4 增值服务",
                "paras": [
                    "会员可尊享门店提供的增值服务，细则以门店说明为准。",
                ],
            },
        ],
    },
        ...
        "blocks": [
            {
                "subtitle": "3.1 预定规则",
                "paras": [
                    "为保障备菜，用餐需提前预约。最早可约日期由后台「提前预约天数」配置（例如提前 1 天则不可约当天）。",
                    "下单时可不强制选择日期；选定日期与餐段后，订单进入该日备菜与核销流程。",
                ],
            },
            {
                "subtitle": "3.2 取消与过期",
                "paras": [
                    "会员免付预约：未选日期的意向单超过保留天数将自动取消；已选日期且过用餐日仍未到店核销的，系统将关闭订单并释放档期。",
                    "非会员待支付订单超时未付将自动取消并释放档期。",
                ],
            },
        ],
    },
        ...
        "blocks": [
            {
                "subtitle": "4.1 规则调整",
                "paras": [
                    "天天聚乐部有权根据经营需要调整会员权益、年费与预约规则。变更将通过小程序公告等方式告知。",
                ],
            },
            {
                "subtitle": "4.2 合规要求",
                "paras": [
                    "禁止转赠、出借、倒卖会员权益；禁止使用技术手段刷单或套取优惠。一经发现，平台有权收回权益，情节严重的可限制账号。",
                    "具体权益以门店解释为准。",
                ],
            },
        ],
...
MEMBER_CONFIG = {
    ...
    "benefits": [
        {"title": "会员订菜免定金", "desc": ""},
        {"title": "享受9折优惠", "desc": "到店消费按会员折扣对账"},
        {"title": "生日月到店消费，送生日蛋糕1份和红酒2瓶", "desc": ""},
        {"title": "尊享增值服务", "desc": ""},
    ],
    "reminders": [
        "会员自开通之日起365天内有效，到期未续费自动失效。",
        "具体权益以门店解释为准。",
    ],
